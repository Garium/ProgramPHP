...
<style>
  ...
  <!-- Footer -->
  <footer class="text-center" style="background-color:#2E2b33" >
    <!-- Grid container -->
    <div class="container">
      <!-- Section: Links -->
      <section class="mt-5">
        ...
        <div class="row text-center d-flex justify-content-center pt-5">
          ...
          <div class="col-md-2">
            <h6 class="text-uppercase font-weight-bold">
              <a href="FeedbackLoggedIn.php" class="links">Feedback</a>
            </h6>
          </div>
          <!-- Grid column -->
          ...
          <div class="col-md-2">
            <h6 class="text-uppercase font-weight-bold">
              <a href="InfoLG.php" class="links">Information Page</a>
            </h6>
          </div>
          <!-- Grid column -->
        </div>
