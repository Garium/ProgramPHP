...
<html lang="en">
  ...
  <body>
   <nav class="navbar navbar-expand-lg" id="Override">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
		...
		<li class="nav-item">
			<a class="nav-link" href="login.html" id="Override">Log in</a>
        </li>
		<li class="nav-item">
          <a class="nav-link" href="register.html" id="Override">register</a>
        </li>
